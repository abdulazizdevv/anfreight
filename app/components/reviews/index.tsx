...
const testimonials = [
  ...
  },
  {
    ...
    name: 'JULIA',
    review:
      'Every time I contact ANFREIGHT, the staff is super kind and helpful. I feel like they really care. Love this level of service!',
  },
];
  ...
  return (
    <>
      <Container pt={{ base: '35px', lg: '100px' }}>
        ...
        >
          Discover why businesses trust ANFREIGHT for reliable and efficient
